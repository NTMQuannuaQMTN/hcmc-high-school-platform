...
const CUTOFFS: Record<string, Record<string, [number, number][]>> = {
  'THPT Lê Quý Đôn': {
    'Ban tự nhiên (Toán – Lý – Hóa)': [[2021, 8.00], [2022, 8.25], [2023, 8.50], [2024, 8.75]],
    'Ban xã hội (Văn – Sử – Địa)':    [[2021, 7.50], [2022, 7.75], [2023, 7.75], [2024, 8.00]],
    'Chương trình tích hợp (song ngữ)': [[2021, 8.50], [2022, 8.75], [2023, 9.00], [2024, 9.25]],
  },
  'THPT Nguyễn Thị Minh Khai': {
    'Ban tự nhiên': [[2021, 7.75], [2022, 8.00], [2023, 8.25], [2024, 8.50]],
    'Ban xã hội':   [[2021, 7.25], [2022, 7.50], [2023, 7.50], [2024, 7.75]],
  },
  'THPT Gia Định': {
    'Ban tự nhiên': [[2021, 7.50], [2022, 7.75], [2023, 8.00], [2024, 8.25]],
    'Ban xã hội':   [[2021, 7.00], [2022, 7.25], [2023, 7.25], [2024, 7.50]],
  },
  'THPT Trần Khai Nguyên': {
    'Đại trà': [[2021, 6.50], [2022, 6.75], [2023, 7.00], [2024, 7.25]],
  },
  'THPT Marie Curie': {
    'Ban tự nhiên':       [[2021, 8.25], [2022, 8.50], [2023, 8.50], [2024, 8.75]],
    'Ban xã hội':         [[2021, 7.75], [2022, 8.00], [2023, 8.00], [2024, 8.25]],
    'Chương trình chuyên Toán': [[2021, 9.00], [2022, 9.25], [2023, 9.25], [2024, 9.50]],
  },
  'THPT Bùi Thị Xuân': {
    'Đại trà': [[2021, 7.00], [2022, 7.25], [2023, 7.50], [2024, 7.75]],
  },
  'THPT Nguyễn Du': {
    'Đại trà': [[2021, 6.75], [2022, 7.00], [2023, 7.25], [2024, 7.50]],
  },
  'THPT Phú Nhuận': {
    'Đại trà': [[2021, 7.25], [2022, 7.50], [2023, 7.75], [2024, 8.00]],
  },
}
